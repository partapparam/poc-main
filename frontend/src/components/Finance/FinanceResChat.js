...
import './FinanceResChat.css'


const FinanceResChat = ({ chatArray, setLoading, source, setIsHistoryPromptClicked, setQuestion, setInputFilled, handleSend }) => {
